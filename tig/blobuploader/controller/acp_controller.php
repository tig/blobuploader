	...
	public function display_options()
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (empty($errors))
			{
				...
				$this->config->set('tig_blobuploader_goodbye', $this->request->variable('tig_blobuploader_goodbye', 0));
				...
				trigger_error($this->language->lang('ACP_BLOBUPLOADER_SETTING_SAVED') . adm_back_link($this->u_action));
			}
		}
		...
		$this->template->assign_vars([
			...
			'TIG_BLOBUPLOADER_GOODBYE'	=> (bool) $this->config['tig_blobuploader_goodbye'],
		]);
	}
