...
class install_sample_schema extends \phpbb\db\migration\migration
{
	...
	{
		return $this->db_tools->sql_column_exists($this->table_prefix . 'users', 'user_blobuploader');
	}
	...
	public function update_schema()
	{
		return [
			'add_tables'		=> [
				$this->table_prefix . 'tig_blobuploader_table'	=> [
					'COLUMNS'		=> [
						'blobuploader_id'			=> ['UINT', null, 'auto_increment'],
						'blobuploader_name'			=> ['VCHAR:255', ''],
					],
					'PRIMARY_KEY'	=> 'blobuploader_id',
				],
			],
			'add_columns'	=> [
				$this->table_prefix . 'users'			=> [
					'user_blobuploader'				=> ['UINT', 0],
				],
			],
		];
	}
