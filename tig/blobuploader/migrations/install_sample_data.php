...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('tig_blobuploader_sample_int');
	}
	...
	public function update_data()
	{
		return [
			...
			['config.add', ['tig_blobuploader_sample_int', 0]],
			['config.add', ['tig_blobuploader_sample_str', '']],

			// Add a new config_text table setting
			['config_text.add', ['tig_blobuploader_sample', '']],
