...
namespace tig\blobuploader\cron\task;

/**
 * Blob Uploader cron task.
 */
class sample extends \phpbb\cron\task\base
{
	...
	public function run()
	{
		...
		$this->config->set('blobuploader_cron_last_run', time(), false);
	}
	...
	{
		return $this->config['blobuploader_cron_last_run'] < time() - $this->cron_frequency;
	}
}
